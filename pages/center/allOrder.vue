        ...
        <swiper-item class="swiper-item">
          ...
          >
            <view class="page-box">
              <view
                class="order"
                v-for="(res, index) in orderList[0]"
                :key="res.id"
              >
                <view class="top">
                  <view class="left">
        ...
        <swiper-item class="swiper-item">
          ...
          >
            <view class="page-box">
              <view
                class="order"
                v-for="(res, index) in orderList[1]"
                :key="res.id"
              >
                <view class="top">
                  <view class="left">
        ...
        <swiper-item class="swiper-item">
          ...
          >
            <view class="page-box">
              <view
                class="order"
                v-for="(res, index) in orderList[3]"
                :key="res.id"
              >
                <view class="top">
                  <view class="left">
        ...
        },
        {
          ...
          goodsList: [
            ...
            },
            {
              ...
              title:
                "蓝妹（BLUE GIRL）酷爽啤酒 清啤 原装进口啤酒 罐装 500ml*9听 整箱装",
              type: "一打",
              deliveryTime: "口感好",
              price: "120",
              number: 1,
